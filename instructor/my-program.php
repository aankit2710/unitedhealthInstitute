...
<div class="col-lg-12">
								...
								<div class="col-lg-12">
									<div class="row mt30">
								<?php
    								$fetch1 = mysqli_query($conn,"SELECT DISTINCT category_name  FROM added_courses WHERE instructor_id=$instructor_id");
                                    $num1 = mysqli_num_rows($fetch1);
                                    while($show1 = mysqli_fetch_assoc($fetch1))
                                    {
                                        $fetch11 = mysqli_query($conn,"SELECT * FROM services");
                                        $show11 = mysqli_fetch_assoc($fetch11);
                                        
                                        $category = $show1['category_name'];
                                ?>	    
