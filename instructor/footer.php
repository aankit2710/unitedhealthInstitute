					...
					<div class="row mt50 mb50">
						<div class="col-lg-6 offset-lg-3">
							<div class="copyright-widget text-center">
								<p class="color-black2">Copyright © <?=date('Y')?> United Health Institute. All rights reserved.</p>
							</div>
						</div>
					</div>
				</div>
...
<script src="app-assets/sweet-alert2/sweetalert2.min.js"></script>
<!-- Custom script for all pages --> 
<script type="text/javascript" src="<?=$base_url?>assets/js/script.js"></script>
<script type="text/javascript">
    window.ALSP={APP:{},f:{},v:{}};
    ALSP.f.path = function(str){return '<?=$base_url?>'+(str||'');};
