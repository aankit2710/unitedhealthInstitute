...
<!-- Title -->
<title>United Health Institute : Terms & Conditions</title>
...
<section class="inner_page_breadcrumb">
			...
			<div class="row">
				<div class="col-xl-6 offset-xl-3 text-center">
					<div class="breadcrumb_content">
						<h4 class="breadcrumb_title">Terms & Conditions</h4>
						<ol class="breadcrumb">
	...
	<?php
$fetch = mysqli_query($conn,"SELECT * FROM terms WHERE user_id='".$user_id."'");
