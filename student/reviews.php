...
mkdir($target_dir, 0777, true);
 ...
 $sql = "INSERT INTO reviews_detail (user_id, c_name, heading, c_review, teacher_name, course_name, rating, created_date, review_image) VALUES ('".$user_id."','".$c_name."','".$heading."','".$c_review."','".$t_name."',,'".$co_name."',,'".$score."',now(),'".$review_image."')";
										...
										<div class="col-7" style="margin:20px auto;height: 26px;text-align: center;">
						                  ...
						                  <div class="col-12">
						                    <div class="form-group">
						                      ...
						                      <input type="text" id="c_name" class="form-control" name="c_name"
						                        placeholder="Customer Name" readonly value="<?=$first_name?>">
						                  ...
						                  <div class="col-12">
						                    <div class="form-group">
						                      ...
						                      <textarea class="editor" cols="80" id="c_review" name="c_review" rows="10"></textarea>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-content">
    								...
    								$fetch1 = mysqli_query($conn,"SELECT * FROM reviews_detail WHERE c_name='$first_name'");
                                    $num1 = mysqli_num_rows($fetch1);
                                    if($num1 > 0){
                                        $i = 1;
                                    while($data = mysqli_fetch_assoc($fetch1))
                                    {
