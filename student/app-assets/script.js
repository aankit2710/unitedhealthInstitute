$('document').ready(function()
{
	...
	function submitForm()
	{
		...
		$.ajax({
			...
			type : 'POST',
			url  : 'student/ajax/auth_user.php',
			data : data,
			beforeSend: function()
			{
				$("#error").fadeOut();
			...
			success :  function(response)
			{
			    ...
			    {
					alert('You Are Authorized To Login Please Contact To System Administrator.');
					//setTimeout(' window.location.href = "instructor/instructor-dashboard.php"; ',1000);
				}
				else if(response=="ok"){

					$("#btn-login").html('Signing In ...');
					setTimeout(' window.location.href = "student/student-dashboard.php"; ',1000);
				}
				else{
