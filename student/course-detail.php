...
<div class="col-lg-12">
									<nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
										<h4 class="title float-left">Course Details</h4>
								...
								<div class="cs_row_one">
									<div class="cs_ins_container">
										...
										<div class="courses_big_thumb row">
										    <?php
                								$fetch1 = mysqli_query($conn,"SELECT * FROM added_courses WHERE course_id = '".$_GET['coures_id']."'");
                                                ...
                                                while($show1 = mysqli_fetch_assoc($fetch1))
                                                {
                                                    ...
                                                    $srcPath = '../uploads/course-videos/instructor-'.$show1['instructor_id'].'/';
